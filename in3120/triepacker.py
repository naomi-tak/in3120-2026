...
class TriePacker:
    ...
    contiguous byte array would not happen from an unpacked trie, but rather from a stream of lexicographically
    sorted strings. See, e.g., https://burntsushi.net/transducers/ for inspiration.
    ...
    def pack(self, trie: Trie, filename: str, explain: bool = False) -> List[PackedCell] | None:
        ...
        while stack1:
            ...
            stack1.extend((child, prefix + symbol) for child, symbol in node.children(True))
