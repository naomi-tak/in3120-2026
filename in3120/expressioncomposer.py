...
class ExpressionComposer:
    ...
    See also https://www.npopov.com/2012/06/15/The-true-power-of-regular-expressions.html for
    something related, but that assumes the PCRE library and makes use of PCRE-specific extensions.
    """
