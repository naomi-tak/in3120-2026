...
class TestEvaluationMetrics(unittest.TestCase):
    ...
    def test_normalized_discounted_cumulative_gain_corner_cases(self):
        self.assertEqual(in3120.EvaluationMetrics.normalized_discounted_cumulative_gain([], []), 0.0)
        self.assertEqual(in3120.EvaluationMetrics.normalized_discounted_cumulative_gain([], [1, 1, 1]), 0.0)
        self.assertEqual(in3120.EvaluationMetrics.normalized_discounted_cumulative_gain([1, 1, 1], []), 0.0)
        with self.assertRaises(AssertionError):
