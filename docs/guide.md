...
Section 8.2 mentions TREC and the Cranfield collection. See [`TREC`](../in3120/trec.py) for a helper class related to managing TREC data, and [`data/trec/cranfield/`](../data/trec/cranfield/) for the Cranfield data in TREC format.
...
In Section 9.1.1 the Rocchio algorithm for relevance feedback is presented. This is implemented by a method in the [`SparseDocumentVector`](../in3120/sparsedocumentvector.py) class.
